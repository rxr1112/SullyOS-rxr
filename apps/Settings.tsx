...
import { resolveImageGenConfig } from '../utils/imageGen';
...
const Settings: React.FC = () => {
  ...
  // 发图配置
  const [localImageGen, setLocalImageGen] = useState(resolveImageGenConfig(apiConfig.imageGen));
            ...
            <div className="space-y-4">
                ...
                <div className="mb-4">
                    <div className="flex items-center gap-2 mb-3">
                        <div className="p-1.5 bg-purple-100/60 rounded-lg text-purple-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
                            </svg>
                        </div>
                        <h3 className="text-sm font-semibold text-slate-700">发图设置</h3>
                    </div>
                    <ImageGenSettingsSection
                        imageGen={localImageGen}
                        onUpdate={(patch) => setLocalImageGen(prev => ({ ...prev, ...patch }))}
                        addToast={addToast}
                    />
                </div>
