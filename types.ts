...
export interface ImageGenChatPrefs {
  width: number;
  height: number;
  stylePrefix: string;
...
export interface ImageWithVoiceMetadata {
  imageGen: ImageGenMetadata;
  memoryText: string;
}
...
export type MessageType = 'text' | 'image' | 'image_with_voice' | 'emoji' | 'interaction' | 'transfer' | 'system' | 'social_card' | 'chat_forward' | 'xhs_card' | 'score_card' | 'music_card' | 'mcd_card' | 'luckin_card' | 'html_card' | 'news_card' | 'vr_card' | 'trpg_card' | 'world_card' | 'sim_card' | 'phone_card' | 'webpage_card';
