...
import { ShareNetwork, Trash, Plus, Smiley, PaperPlaneTilt, Money, BookOpenText, GearSix, Image, Lock, ArrowsClockwise, ChatCircleDots, CalendarBlank, ForkKnife, Coffee, Code, Brain, PencilSimple, Sparkle } from '@phosphor-icons/react';
                    ...
                    {showPanel === 'actions' && (
                        ...
                        >
                          ...
                          <div className={`p-6 grid grid-cols-4 gap-8 ${actionsPage === 1 ? '' : 'hidden'}`}>
                            ...
                            <button
                              onClick={() => onPanelAction('image-gen')}
                            ...
                            >
                              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-sm border ${isDiscordStyle ? 'bg-slate-800 text-fuchsia-300 border-fuchsia-400/20' : 'bg-fuchsia-50 text-fuchsia-500 border-fuchsia-100'}`}>
                                  <Sparkle className="w-6 h-6" weight="bold" />
                              </div>
                              <span className="text-xs font-bold">发图片</span>
                            </button>
